...
namespace Game.Terrain
{
	...
	public abstract class MapElement : MessagingObject
	{
		...
		public bool AcousticObstacle { get; protected set; }
		...
		/// </summary>
		public Vector2 GetClosestPointToPlayer()
			=> _area.Value.GetClosestPoint(World.Player.Center);
		...
		{
			Vector2 position2d = _area.Value.GetClosestPoint(CameraManager.Get2dPosition());
			return position2d.ToVector3(Camera.main.transform.position.y);
		}
