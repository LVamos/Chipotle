...
namespace Game.Terrain
{
    ...
    {
        public Vector2 SnapToGrid(Vector2 point, float tileSize = TileSize)
        {
        ...
        private void DrawPanel(XElement panel, Rectangle zoneArea)
        {
            ...
            HashSet<Vector2> points = panelArea.GetPoints(TileSize);
            bool Contains(Vector2 p) => panelArea.Contains(p);
            bool ul = Contains(panelArea.UpperLeftCorner);
            bool ur = Contains(panelArea.UpperRightCorner);
            bool ll = Contains(panelArea.LowerLeftCorner);
            bool lr = Contains(panelArea.LowerRightCorner);
