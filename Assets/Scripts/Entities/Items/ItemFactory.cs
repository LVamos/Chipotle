...
namespace Game.Entities.Items
{
    public class ItemFactory
    {
        ...
        private static Dictionary<string, ItemCreationParameters> _itemParameters = new();
        ...
        public static Item Create(XElement itemNode, XElement zoneNode, bool createGameObject = false)
        {
            ...
            bool acousticObstacle = Extract("acousticObstacle").ToBool();
            ...
            bool acousticObstacle = false)
        {
            ...
            ItemCreationParameters parameters;
