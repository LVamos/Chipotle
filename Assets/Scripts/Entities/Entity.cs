...
namespace Game.Entities
{
	...
	public class Entity : MapElement
	{
		...
		public void Initialize(Name name, string type, Rectangle? area)
		{
			...
			_sounds = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
		...
		protected virtual void Move(Game.Terrain.Rectangle targetArea)
		{
			Area = (Rectangle?)targetArea ?? throw new ArgumentNullException(nameof(targetArea));
		}
