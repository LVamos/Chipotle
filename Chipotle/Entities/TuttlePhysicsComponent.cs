...
namespace Game.Entities
{
    ...
    public class TuttlePhysicsComponent : PhysicsComponent
    {
        ...
        protected Queue<Vector2> FindPath(Vector2 goal, bool throughGoal = true)
        {
            ...
            return World.FindPath(_area.Center, goal, false, throughDoors, false, sameLocality, true, throughGoal);
        }
...
=> World.GetDistance(_area.Center, _goal);
        ...
        private void GoToPlayer()
        {
            ...
            _path = FindPath(_player.Area.Center);

            if (_path == null)
                return;

            _goal = _player.Area.Center;
