...
namespace Luky
{
    ...
    {
        /// <summary>
        /// Specifies if the related sound is prepared.
        /// </summary>
        ...
        /// <param name="id">Current volume of the sound source</param>
        ...
        public FadingRecord(FadingType type, float volume, float volumeDelta, float targetVolume)
        {
            Type = type;
            Volume = volume;
